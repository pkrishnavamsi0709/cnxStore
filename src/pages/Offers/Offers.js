...
import { Clock, Tag, Gift, Star, Zap, TrendingUp, ShoppingCart, Heart, Instagram, Facebook, Search, Calendar } from "lucide-react";
    ...
    <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
      <div className={`bg-gradient-to-r ${offer.gradient} p-6 text-white relative overflow-hidden`}>
        ...
        <div className="relative z-10">
          ...
          {offer.timer && (
            <div className="mt-4">
              <DealTimer endTime={new Date().getTime() + offer.timer * 60 * 60 * 1000} />
            </div>
          )}
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="mb-4">
          <h4 className="font-bold text-lg mb-3 text-gray-800">What's Included:</h4>
...
const SeasonalOffers = () => {
  ...
  return (
    <div className="mb-12">
      <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Seasonal Offers</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {seasonalDeals.map((deal, index) => (
          <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
            <div className={`bg-gradient-to-r ${deal.gradient} p-6 text-white text-center`}>
...
const MembershipOffers = () => {
  const membershipTiers = [
    {
      name: "Silver Member",
      benefits: ["5% discount on all purchases", "Free shipping on orders above ₹999", "Early access to sales", "Birthday special discount"],
      requirement: "Spend ₹10,000 annually",
      color: "from-gray-400 to-gray-600"
    },
    {
      name: "Gold Member",
      benefits: ["10% discount on all purchases", "Free shipping on all orders", "Exclusive member-only deals", "Priority customer support", "Extended return policy"],
      requirement: "Spend ₹25,000 annually",
      color: "from-yellow-400 to-yellow-600"
    },
    {
      name: "Platinum Member",
      benefits: ["15% discount on all purchases", "Free express shipping", "Personal shopping assistant", "VIP customer events", "Complimentary gift wrapping", "Exclusive product previews"],
  ...
  return (
    <div className="mb-12">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">cnxStore Membership Benefits</h2>
        <p className="text-lg text-gray-600">The more you shop, the more you save! Join our loyalty program today.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {membershipTiers.map((tier, index) => (
          <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-primeColor">
    ...
    <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 mb-12 border border-orange-100">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-3">
          Exciting Deals, Every Day – Only on <span className="text-primeColor">cnxStore!</span>
        </h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          We love to reward our customers. Whether you're shopping for the first time or are a loyal buyer, 
          cnxStore always has something extra for you.
        </p>
      </div>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {currentOffers.map((offer, index) => (
            <div key={index} className={`${offer.color} border-2 rounded-xl p-6 hover:shadow-lg transition-all duration-300`}>
              <div className="flex items-start gap-3 mb-4">
                {offer.icon}
                <div className="flex-1">
                  <h4 className="font-bold text-gray-800 mb-2">{offer.title}</h4>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-gray-800">Limited-Time Deals</h3>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {limitedTimeDeals.map((deal, index) => (
            <div key={index} className="bg-white rounded-xl p-6 border-2 border-gray-100 hover:border-primeColor hover:shadow-lg transition-all duration-300">
      ...
      <div className="bg-gradient-to-r from-primeColor to-black rounded-xl p-6 text-white">
        ...
        <p className="text-lg mb-6">
          Follow us on Instagram and Facebook for early access to exclusive coupon codes.
        </p>
...
const Offers = () => {
  ...
  const offerTypes = [
    {
      ...
      details: "As a new customer, you get access to our best introductory offers. This deal is valid for 7 days from account creation and can be used on any category except electronics. Combine with seasonal sales for maximum savings!",
    ...
    },
    {
      ...
      details: "Our most popular sale event! Flash sales run every Friday from 9 AM to 9 PM. Items are added hourly with limited quantities. Pro tip: Enable push notifications to get instant alerts when your wishlist items go on sale.",
    ...
    },
    {
      ...
      details: "Perfect for businesses, events, or large families. Our bulk purchase program offers tiered discounts that increase with quantity. Business customers get additional benefits like credit terms and priority processing.",
    ...
    },
    {
      ...
      details: "Spread the word about cnxStore and earn amazing rewards! Your referral link gives friends 25% off their first purchase, and you earn ₹500 when they complete their first order. Track your referrals and earnings in your account dashboard.",
    ...
    },
    {
      ...
      details: "We believe in supporting students and honoring seniors. After quick ID verification, enjoy permanent discounts on all purchases. These discounts can be combined with most sale offers for even greater savings.",
    ...
    },
    {
      ...
      details: "Make your special days even more special! Get exclusive discounts during your birthday month and purchase anniversary. We also send surprise discount codes for other personal milestones. Update your profile to never miss these celebrations!",
  ...
  return (
    <div className="max-w-container mx-auto px-4">
      ...
      <div className="pb-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            <span className="text-primeColor">Orebi</span> Special Offers
          </h1>
          <p className="text-lg text-lightText max-w-2xl mx-auto">
            ...
            Limited time offers with up to 70% off selected items!
          </p>
        </div>
      ...
      <div className="mb-12">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Explore Our Offer Categories</h2>
          <p className="text-lg text-gray-600">Discover the perfect deal for every shopping need</p>
        </div>
